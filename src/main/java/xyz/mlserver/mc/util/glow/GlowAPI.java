package xyz.mlserver.mc.util.glow;
...
import xyz.mlserver.mc.util.glow.listeners.EntityMetadataListener;
import xyz.mlserver.mc.util.glow.listeners.PlayerJoinListener;
import xyz.mlserver.mc.util.glow.listeners.PlayerQuitListener;
import xyz.mlserver.mc.util.glow.packetwrappers.WrapperPlayServerEntityMetadata;
import xyz.mlserver.mc.util.glow.packetwrappers.WrapperPlayServerScoreboardTeam;
...
public class GlowAPI extends JavaPlugin {
    ...
    public static CompletableFuture<Void> setGlowingAsync(@Nullable Entity entity,
                                                          boolean glowing,
                                                          @NotNull Player player) {
        return setGlowingAsync(entity, glowing ? Color.NONE : null, player);
    }
